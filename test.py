#! /usr/bin/python
# -*- coding: utf-8 -*-
## @Author: pengyiyu01(pengyiyu01@baidu.com)
## @Created: 2018/07/18 18:58:38 (Wed)
...
def parse_soup_v1(soup):
    print(soup.title.text.encode("utf-8"))
    for link  in soup.findAll(name='img',attrs={"src":re.compile(r'^http')}):
        print link.get('src')

if __name__ == "__main__":
    get_page("https://www.wikiart.org/en/grandma-moses/apple-butter-making-1947", "./test.html")
